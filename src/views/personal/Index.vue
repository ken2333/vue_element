      ...
      <el-tabs v-model="activeName">
        <el-tab-pane label="基本信息" name="index">
          ...
          <div class="panel-heading">
            ...
            <span class="title"><p class="role">{{postion}}</p><span class="name">{{aliasname}}</span> </span>
            ...
            <ul>
              ...
              <li>
                <el-row :gutter="20">
                  ...
                  <el-col :span="6">1995-12-1</el-col>
                </el-row>
              </li>
              <li>
                <el-row :gutter="20">
